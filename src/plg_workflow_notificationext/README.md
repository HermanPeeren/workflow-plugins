...
* In Notificationext.php the onWorkflowAfterTransition() method was changed to also include the original author, the last modifier, and the current user, if applicable.