...
A workflow plugin to make a draft copy of an already published article, in order to edit the article in a Revision Draft stage. It can be submitted to a Revision Review Stage, and after approval will be copied back to the published article. The versioning of the draft wil also be copied back to the original article's versioning stack, after which the draft article is deleted.
...
This plugin is limited to articles in com_content.
